...
public slots:
     ...
     * @details Log the message to the console.
     ...
     * @details Set the log level for both console and richtext.
     ...
     * @details Set the color mode for console.
     ...
     * @details Set the color mode for richtext.
     * @param color The color mode to set.
     *              - true is color.
     *              - false is colorless.
     */
     ...
     * @details Set the color mode for both console and richtext.
     * @param color The color mode to set.
     *              - true is color.
     *              - false is colorless.
...
signals:
     ...
     * @details Log the message to the richtext.
     * @param message The log message.
     */
